 ...
 */
class CostrictExtensionProvider : ExtensionProvider {
    ...
    override fun initialize(project: Project) {
        // Initialize costrict extension configuration
        ...
        try {
            ...
            // This allows costrict to work independently
        }
    }
    ...
    override fun isAvailable(project: Project): Boolean {
        ...
        val extensionConfig = ExtensionConfiguration.getInstance(project)
        val config = extensionConfig.getConfig(ExtensionType.COSTRICT)
